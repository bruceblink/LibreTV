...
async function checkForUpdates() {
    try {
        ...
        let latestVersion;
        const VERSION_URL = {
            PROXY: 'https://ghfast.top/raw.githubusercontent.com/bruceblink/LibreTV/main/VERSION.txt',
            DIRECT: 'https://raw.githubusercontent.com/bruceblink/LibreTV/main/VERSION.txt'
        };
            ...
            setTimeout(() => {
                ...
                if (updateBtn) {
                    updateBtn.addEventListener('click', () => {
                        window.open('https://github.com/bruceblink/LibreTV', '_blank');
                    });
                }
            }, 100);
        } else {
